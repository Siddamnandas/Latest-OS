...
registry.registerPath({ method: "get", path: "/api/notifications", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "post", path: "/api/notifications", responses: { 200: { description: "Success" } } });
