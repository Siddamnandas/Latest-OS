...
registry.registerPath({ method: "get", path: "/api/voice-sessions", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "post", path: "/api/voice-sessions", responses: { 200: { description: "Success" } } });
