...
registry.registerPath({ method: "get", path: "/api/family/activities", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "post", path: "/api/family/activities", responses: { 200: { description: "Success" } } });
