...
registry.registerPath({ method: "get", path: "/api/family/children", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "post", path: "/api/family/children", responses: { 200: { description: "Success" } } });
