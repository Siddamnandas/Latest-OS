...
registry.registerPath({ method: "get", path: "/api/offline/sync", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "post", path: "/api/offline/sync", responses: { 200: { description: "Success" } } });
