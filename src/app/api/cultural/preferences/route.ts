...
registry.registerPath({ method: "get", path: "/api/cultural/preferences", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "put", path: "/api/cultural/preferences", responses: { 200: { description: "Success" } } });
