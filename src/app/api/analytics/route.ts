...
registry.registerPath({ method: "get", path: "/api/analytics", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "post", path: "/api/analytics", responses: { 200: { description: "Success" } } });
