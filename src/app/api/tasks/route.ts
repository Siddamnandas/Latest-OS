...
registry.registerPath({ method: "get", path: "/api/tasks", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "post", path: "/api/tasks", responses: { 200: { description: "Success" } } });
