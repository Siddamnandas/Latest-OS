...
registry.registerPath({ method: "get", path: "/api/privacy/settings", responses: { 200: { description: "Success" } } });
registry.registerPath({ method: "put", path: "/api/privacy/settings", responses: { 200: { description: "Success" } } });
